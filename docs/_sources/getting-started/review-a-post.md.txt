...
Shodoで記事をレビューするには、執筆タスク画面から「レビューする」タブをクリックします。
...
レビューをOKにする場合、 **レビュー画面右上の「レビューOKにする」ボタンをクリック** してください。
...
記事が書き終わったあとにブログ記事の公開などが必要な場合、「アサイン」や「期限」も同時に変更して、記事の公開作業を依頼しましょう。
レビューOKの状態は「記事は書き上がったが、タスクとしてはまだ完了でない」という状態です。

### レビューを差し戻す場合

記事を書き直してほしいときは、レビューコメントをしたあとに記事の修正を依頼しましょう。
**レビュー画面右上の「記事の修正を依頼する」ボタンをクリック** してください。
